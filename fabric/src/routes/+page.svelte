...
<form id="fabric-survey" class="relative w-screen h-screen" method="post" target="_blank">
  ...
  <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-sky-400 bg-sky-100">
    ...
    <input form="fabric-survey" name="qual" id="qual-textbox" bind:value={qual} size={qual ? qual.length : 2} maxlength="12" class="mx-auto pr-1 rounded-l-full text-right bg-transparent min-w-10 pl-1">
